...
@Composable
fun UserListChooseDisplay(
    modifier: Modifier = Modifier,
    navController: NavController,
    viewState: UserListChooseViewState.Display,
    onUpdateSelectedItem:(UserCardItemModel)->Unit,
    onBackToSell:()->Unit
) {
/*
    Surface(
            ...
            stickyHeader {
                Row(
                    ...
                    viewState.items.forEach{
                        item{
                            UserCardItem(model = it, onClickCardItem = {
                               onUpdateSelectedItem(it)
                            })
                        }
                    }
